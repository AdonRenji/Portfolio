...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-[92vh] flex items-center justify-center bg-mesh-dark overflow-hidden py-16 lg:py-24">
      {/* Background Tech Grid Overlay */}
      <div className="absolute inset-0 grid-overlay opacity-20 pointer-events-none" />

      {/* Radiant Glow Blobs */}
      <div className="absolute top-[-10%] left-[-10%] w-[50vw] h-[50vw] max-w-[600px] rounded-full bg-indigo-500/10 blur-[130px] animate-float-slow pointer-events-none" />
        ...
        >
          ...
          <div className="lg:col-span-7 flex flex-col items-center text-center lg:items-start lg:text-left space-y-6 md:space-y-8">
            ...
            <motion.div variants={itemVariants} className="space-y-3">
              <h2 className="text-sm md:text-base font-semibold uppercase tracking-wider text-indigo-400/90 font-mono">
                Hi, my name is
              </h2>
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-tight text-white leading-none">
                Adon Renji
              </h1>
              <div className="text-xl sm:text-2xl md:text-3xl font-medium text-zinc-300 mt-2 h-[40px] flex items-center justify-center lg:justify-start">
                <span className="text-zinc-400 mr-2 font-light">I am a</span>
                <Typewriter 
            ...
            <motion.p
              ...
              className="text-base sm:text-lg text-zinc-400 max-w-xl leading-relaxed font-light"
            >
            ...
            >
              ...
              <a
                ...
                className="flex items-center justify-center gap-2 h-13 px-8 rounded-xl font-semibold text-zinc-300 hover:text-white glass-panel hover:bg-white/10 transition-all duration-300 border border-white/10 hover:border-white/20 active:scale-[0.98] w-full sm:w-auto"
              >
                Contact Me
              </a>
              ...
              <a
                ...
                className="flex items-center justify-center gap-2 h-13 px-6 rounded-xl font-semibold text-indigo-300 hover:text-indigo-200 hover:bg-indigo-500/5 transition-all duration-300 border border-indigo-500/20 hover:border-indigo-500/40 active:scale-[0.98] w-full sm:w-auto"
            ...
            <motion.div
              variants={itemVariants}
              className="flex items-center gap-6 pt-4 border-t border-zinc-800/40 w-full justify-center lg:justify-start"
            >
              <a
              ...
              <a
                ...
                className="text-zinc-500 hover:text-pink-400 transition-colors duration-200"
          ...
          <div className="lg:col-span-5 flex justify-center items-center">
            ...
            >
              ...
              <div className="relative w-[280px] h-[340px] sm:w-[320px] sm:h-[390px] md:w-[340px] md:h-[410px] rounded-2xl overflow-hidden glass-panel border border-white/10 p-2.5 z-10">
